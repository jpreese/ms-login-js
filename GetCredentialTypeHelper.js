...
function GetCredentialTypeRequestHelper(serverData, flags)
{
    ...
    var _unauthSessionID = _serverData.M;
    var _allowedIdentities = _serverData.K;
    var _isFederationDisabled = _serverData.a0;
    var _isRemoteNGCSupported = !!_serverData.a9;
    var _showCookieBanner = !!_serverData.Bi;
    var _isFidoSupportedHint = !!_serverData.Ag;
    var _isOtcLoginDisabled = _serverData.a5;
    var _isNoPaOtcDisabled = _serverData.a3;
    var _isExternalFederationDisallowed = !!_serverData.aZ;
    var _isPassthroughDisallowed = !!_serverData.a6;
    var _isPhoneNumberSignupDisallowed = !!_serverData.a7;
    var _originalRequest = _serverData.C;
    var _redirectToSignupOnNotExists = _serverData.Af; 
    var _checkProofForAliases = _serverData.aP; 
    var _checkApiCanary = _serverData.j;
    var _getCredentialTypeUrl = _serverData.bO;
    var _isSignupAllowed = _serverData.Ar;
    var _allowSkype = _serverData.AQ;
    var _msaSignupUrl = serverData.urlMsaSignUp;
    var _signupUrl = _serverData.G;
    var _signupUrlPostParams = _serverData.R;
    var _useConsumerEmailError = _serverData.fUseConsumerEmailError;
    var _otherIdpRedirectPostParams = _serverData.L;
    ...
    var _postProofType = parseInt(_serverData.bH);
    var _changePasswordUrl = _serverData.bN;
    var _remoteConnectEnabled = !!_serverData.ao;
    var _bindCookiesUsingPoP = _serverData.fBindCookiesUsingPoP;
    var _gctFederationFlags = _serverData.BT || 0;
    var _ignoreViralUsers = _serverData.fIgnoreViralUsers;
    var _isAccessPassSupported = _serverData.fAccessPassSupported;
    var _hidePhoneCobasiInOtherSignIn = _serverData.aw;
                    ...
                    switch (eligibleProof.type)
                    {
                        ...
                        case PROOF.Type.Voice:
                            if (!eligibleProof.isVoiceOnly)
                            {
                                ...
                                if (_hidePhoneCobasiInOtherSignIn)
                                {
